...
IMAGES = {}  # dictionary of images referenced by type
...
def main():
    ...
    running = True
    sqSelected = ()  # no square selected initially, keep track of users last click; tuple: (row, col)
    playerClicks = []  # keep track of player clicks; two tuples e.g: [(6,4), (4,4)]
